...
const EnhancedChatApp = () => {
  ...
  const [contacts, setContacts] = useState([
    ...
    { id: 6, name: 'Team Project', avatar: 'https://media.istockphoto.com/id/1618846975/photo/smile-black-woman-and-hand-pointing-in-studio-for-news-deal-or-coming-soon-announcement-on.jpg?s=612x612&w=0&k=20&c=LUvvJu4sGaIry5WLXmfQV7RStbGG5hEQNo8hEFxZSGY=', lastMessage: "Meeting tomorrow at 2 PM", time: 'Monday', unread: 0, isGroup: true, members: 5, status: '📅 Active project' },
    { id: 7, name: 'Family Group', avatar: 'https://img.freepik.com/free-photo/young-adult-man-wearing-hoodie-beanie_23-2149393636.jpg', lastMessage: "Let's plan for the weekend", time: 'Sunday', unread: 3, isGroup: true, members: 8, status: '👨‍👩‍👧‍👦 Family chat' },
